...
install_ripgrep:
  pkg.installed:
    - sources:
      - ripgrep: https://github.com/BurntSushi/ripgrep/releases/download/{{ system.tools.ripgrep.version }}/ripgrep_{{ system.tools.ripgrep.version }}_amd64.deb
...
install_fd:
  pkg.installed:
    - sources:
      - fd: https://github.com/sharkdp/fd/releases/download/v{{ system.tools.fd.version }}/fd_{{ system.tools.fd.version }}_amd64.deb
